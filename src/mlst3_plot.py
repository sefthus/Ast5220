...
for i in range(len(k)):
    plt.plot(x,delta[i],label=(r'$k$'+'=%.2f'% ks[i]))
...
plt.figure()
for i in range(len(k)):
    plt.plot(x,delta_b[i],label=(r'$k$'+'=%.2f'% ks[i]))
plt.legend(loc='upper left')
...
plt.figure()
for i in range(len(k)):
    plt.plot(x,v[i],label=(r'$k$'+'=%.2f'% ks[i]))
plt.legend(loc='upper left')
plt.ylabel(r'$v$')
plt.xlabel(r'$x$')
#plt.grid('on', linestyle ='--')
...
plt.figure()
for i in range(len(k)):
    plt.plot(x,v_b[i],label=(r'$k$'+'=%.2f'% ks[i]))
plt.legend(loc='upper left')
plt.ylabel(r'$v_b$')
plt.xlabel(r'$x$')
#plt.grid('on', linestyle ='--')
...
plt.figure()
for i in range(len(k)):
    plt.plot(x,Phi[i],label=(r'$k$'+'=%.2f'% ks[i]))
plt.legend(loc='upper left')
plt.ylabel(r'$\Phi$')
plt.xlabel(r'$x$')
#plt.grid('on', linestyle ='--')
...
plt.figure()
for i in range(len(k)):
    plt.plot(x,Psi[i],label=(r'$k$'+'=%.2f'% ks[i]))
plt.legend(loc='upper left')
plt.ylabel(r'$\Psi$')
plt.xlabel(r'$x$')
#plt.grid('on', linestyle ='--')
...
plt.figure()
for i in range(len(k)):
    plt.plot(x,Theta0[i],label=(r'$k$'+'=%.2f'% ks[i]))
plt.legend(loc='upper left')
...
plt.figure()
for i in range(len(k)):
    plt.plot(x,Theta1[i],label=(r'$k$'+'=%.2f'% ks[i]))
plt.legend(loc='upper left')
